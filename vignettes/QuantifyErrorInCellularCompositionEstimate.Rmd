...
for(each in colnames(cellCompRGSet)[1:6]){
  plot(cellCompRGSet[,each], cellCompMatrix[,each], pch = 16, xlab = "RGChannelSet", ylab = "Matrix", main = each, cex.axis = 1.5, cex.lab = 1.5, cex.main = 1.5)
}
```
